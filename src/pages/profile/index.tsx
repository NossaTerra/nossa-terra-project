          ...
          >
            ...
            {isEditing && user.role === "buyer" && (
              <>
                ...
                <BuyerForm isEditing user={user} className="mb-10 md:pl-2" />
              </>
            )}
            {!isEditing && user.role === "buyer" && (
  ...
  return (
    <Dialog modal>
      <DialogTrigger asChild>
        <Button
          variant={ "ghost"}
          className={cn(isSeller ? "mt-12 md:mt-16 mb-4 w-full md:w-52 lg:fixed lg:bottom-4 lg:right-4" : " fixed bottom-2 right-2 ", "text-md md:bottom-14 md:right-14")}
        >
        ...
        <div className="flex space-x-4 md:items-center">
          <Avatar className="flex ">
            ...
            <AvatarFallback
              ...
              className={`flex h-20 w-20 md:h-24 md:w-24 items-center justify-center rounded-full border border-slate-200`}
            >
              ...
              {user.instagram && (
                <div className="mt-1 flex items-center">
                  <Image
                    ...
                    alt="Instagram Icon"
                  />
                  <span className="ml-3.5 text-sm">{user.instagram}</span>
                </div>
              )}
            </div>
          </div>
