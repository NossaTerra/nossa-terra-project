                            ...
                            <tr>
                              <td role="modules-container"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%"
                                  role="module" data-type="columns" style="padding:30px 0px 30px 30px;" bgcolor="#C2EFd3"
                                  data-distribution="1">
                                  <tbody>
                                              ...
                                              <td style="padding:0px;margin:0px;border-spacing:0;">
                                                <table class="wrapper" role="module" data-type="image" border="0"
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                      <td
                                                        style="font-size:6px; line-height:10px; padding:0px 30px 0px 0px;"
                                                        ...
                                                        <img class="max-width" border="0"
                                                          ...
                                                          src="http://cdn.mcauto-images-production.sendgrid.net/dd103c6d880eec94/9132f06f-4681-409c-8a66-1762378dec36/100x114.png"
                                                          height="114">
                                                      </td>
                                                    </tr>
                                                  </tbody>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%"
                                  role="module" data-type="columns" style="padding:50px 0px 0px 30px;" bgcolor="#FEFEF6"
                                  data-distribution="1">
                                  <tbody>
                                    <tr role="module-content">
                                      <td height="100%" valign="top">
                                              ...
                                              <td style="padding:0px;margin:0px;border-spacing:0;">
                                                <table class="module" role="module" data-type="text" border="0"
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                      <td
                                                        style="padding:18px 40px 0px 0px; line-height:28px; text-align:inherit;"
                                                        height="100%" valign="top" bgcolor="" role="module-content">
                                                        <div>
                                                          <div style="font-family: inherit; text-align: inherit"><span
                                                              style="font-size: 24px; color: #1e803d"><strong>Olá!&nbsp;</strong></span>
                                                          </div>
                                                          <div style="font-family: inherit; text-align: inherit"><span
                                                              style="font-size: 24px; color: #1e803d"><strong>Esqueceu a
                                                                senha do Nossa Terra?</strong></span></div>
                                                          <div></div>
                                                        </div>
                                                      </td>
                                                    </tr>
                                                ...
                                                <table class="module" role="module" data-type="text" border="0"
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                      <td
                                                        style="padding:18px 40px 10px 0px; line-height:16px; text-align:inherit;"
                                                        height="100%" valign="top" bgcolor="" role="module-content">
                                                        <div>
                                                          ...
                                                          <div style="font-family: inherit; text-align: inherit"><span
                                                              style="color: #2a1c0f; font-size: 18px">Clicando no botão
                                                              abaixo você vai ser redirecionado para a página de criar
                                                              nova senha!</span></div>
                                                          <div style="font-family: inherit; text-align: inherit"><br>
                                                          </div>
                                                          <div></div>
                                                ...
                                                <table class="module" role="module" data-type="spacer" border="0"
                                                  cellpadding="0" cellspacing="0" width="100%"
                                                  style="table-layout: fixed;"
                                                  data-muid="c97177b8-c172-4c4b-b5bd-7604cde23e3f.1">
                                                  <tbody>
                                                    <tr>
                                                ...
                                                <table class="module" role="module" data-type="text" border="0"
                                                  ...
                                                  <tbody>
                                                    <tr>
                                                      <td
                                                        style="padding:18px 40px 10px 0px; line-height:20px; text-align:inherit;"
                                                        height="100%" valign="top" bgcolor="" role="module-content">
                                                        <div>
                                                          <div style="font-family: inherit; text-align: inherit"><br>
                                                          </div>
                                                          <div style="font-family: inherit; text-align: inherit"><span
                                                              style="font-family: arial, helvetica, sans-serif; font-size: 14px; color: 000000px"><strong>Se
                                                                você não solicitou uma alteração de
                                                                senha</strong></span><span
                                                              style="font-family: arial, helvetica, sans-serif; font-size: 14px; color: #2a1c0f">,
                                                              entre em contato conosco imediatamente para que possamos
                                ...
                                <table class="module" role="module" data-type="divider" border="0" cellpadding="0"
                                  ...
                                  data-muid="38ec2680-c847-4765-8c5f-aa2aba19a2b3">
                                  <tbody>
                                    <tr>
                                      <td style="padding:0px 0px 0px 0px;" role="module-content" height="100%"
                                        valign="top" bgcolor="">
                                        <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%"
                                          height="7px" style="line-height:7px; font-size:7px;">
                                          <tbody>
                                            <tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" class="module" data-role="module-button"
                                  ...
                                  data-muid="840a78da-be53-493f-8903-70244289fe77">
                                  <tbody>
                                    <tr>
