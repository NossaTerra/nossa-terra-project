...
export function buyerValidatedEmail(): string {
  return `
...
<![endif]-->
  ...
  <tr>
    <td role="module-content">
      <p>Seja bem vindo e boas negociações.</p>
    </td>
  </tr>
  ...
  <tbody>
    <tr>
      <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
        <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;" width="100" alt="" data-proportionally-constrained="true" data-responsive="false" src="http://cdn.mcauto-images-production.sendgrid.net/dd103c6d880eec94/9132f06f-4681-409c-8a66-1762378dec36/100x114.png" height="114">
      </td>
    </tr>
  </tbody>
  ...
  <tbody>
    <tr>
      <td style="padding:50px 30px 18px 30px; line-height:36px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 43px">A espera acabou!</span></div>
<div style="font-family: inherit; text-align: center"><span style="font-size: 43px">Seja bem vindo à</span><span style="font-size: 43px; color: #22c880"> Nossa Terra</span></div><div></div></div></td>
    </tr>
  </tbody>
</table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="a10dcb57-ad22-4f4d-b765-1d427dfddb4e" data-mc-module-version="2019-10-22">
  <tbody>
    <tr>
      <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 18px">&nbsp;O seu cadastro foi validado e partir de agora</span><span style="font-size: 18px"><strong> sua empresa já pode criar anúncios</strong></span><span style="font-size: 18px"> no nossa terra!</span><span style="color: #000000; font-size: 18px; font-family: arial, helvetica, sans-serif">&nbsp;</span></div>
<div style="font-family: inherit; text-align: center"><span style="font-size: 18px; color: #0f172a">Muito obrigado por escolher o nosso serviço!</span></div><div></div></div></td>
    </tr>
  </tbody>
      ...
      <tr>
        <td align="center" bgcolor="#ffffff" class="outer-td" style="padding:0px 0px 0px 0px; background-color:#ffffff;">
          <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
            <tbody>
              <tr>
              <td align="center" bgcolor="#15B16D" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                <a href="${env.APP_URL}" style="background-color:#15B16D; border:1px solid #15B16D; border-color:#15B16D; border-radius:0px; border-width:1px; color:#000000; display:inline-block; font-size:14px; font-weight:bold; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;" target="_blank">Ir para o site nossa terra</a>
              </td>
              </tr>
            </tbody>
          </table>
  ...
  <tbody>
    <tr>
      <td style="padding:50px 30px 50px 30px; line-height:20px; text-align:inherit; background-color:#9ADFC1;" height="100%" valign="top" bgcolor="#9ADFC1" role="module-content"><div><div style="font-family: inherit; text-align: justify"><span style="font-size: 18px; color: #0f172a">A partir de agora sua empresa pode criar anúncios de seus produtos e receber contatos da rede de produtores nossa terra! Aproveite os nossos serviços, nós te desejamos excelentes negociações.</span></div><div></div></div></td>
    </tr>
  </tbody>
</table></td>
      </tr>
